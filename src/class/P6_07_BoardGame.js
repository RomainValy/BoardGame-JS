class BoardGame {
    ...
    weaponPlacement(element) {
        if (element && element.name !== this.player1.arme.name) {
            /**
             * @method shuffleNumber selectionne un nombre "aléatoire" entre les deux parametre donnée et renvoi l'entier superieur
             * @param {number, number}
             */
    ...
    /**
     * utilise la methode prededente pour placer les rochers sur les cases qui reste aléatoirement
     */
    wallsPlacement() {
    ...
    // ajoute des cases vides sur les emplacements vide de EmptyArray
    emptyCasesPlacement() {
